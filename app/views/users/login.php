           ...
           <form action="<?php echo URLROOT;?>/Users/login" method="post">
            ...
            <div class="form-group">
                ...
                <input type="password" name="password" class="form-control form-control-lg <?php 
                  echo (!empty($data['password_err']))? 'is-invalid':'';?>" value="<?php echo $data['password'];?>"> 
            ...
            <div class="row">
                ...
                <div class="col">
                    <a href="<?php echo URLROOT; ?>/Users/register" class="btn btn-light btn-block">have not an account? Register?</a>
                </div>
            </div>
            </form>
        </div>
